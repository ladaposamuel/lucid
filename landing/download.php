...
<section class="preview-section">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-10">
				<img src="/img/lucid-preview.jpg" class="img-fluid lucid-laptop" alt="Lucid" />
			</div>
		</div>
	</div>
</section>
...
<section class="feature-section">
	<div class="container">
		...
		<div class="row text-white pt-4">
			<div class="col-md-6">
				<div class="feat-col">
					<img src="/img/14019879701543984325.png" alt="Tell Your Story on Lucid" class="img-fluid pb-4" />
			...
			<div class="col-md-6">
				<div class="feat-col">
					<img src="/img/17101174831552994197.png" alt="You Are in Safe Hands" class="img-fluid pb-4" />
		...
		<div class="row text-white pt-4">
			<div class="col-md-6">
				<div class="feat-col">
					<img src="/img/16143869721535958154.png" alt="Your Right to Privacy" class="img-fluid pb-4" />
			...
			<div class="col-md-6">
				<div class="feat-col">
					<img src="/img//4804552381535029667.png" alt="In One Simple Set up" class="img-fluid pb-4" />
