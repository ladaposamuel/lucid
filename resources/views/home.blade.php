			...
			<!-- Beginning of Post Content -->
				<div class="post-content">
					<div class="post-image d-none d-lg-flex d-xl-flex d-md-flex">
						<img src="{{ asset('img/post-1.jpg') }}" class="img-fluid post-img"
				...
				<div class="post-content">
					<div class="post-image d-none d-lg-flex d-xl-flex d-md-flex">
						<img src="{{ asset('img/post-2.jpg') }}" class="img-fluid post-img"
							alt="Looking For Where To Spend Christmas in the comform of your home" />
					</div>
					<div class="post-content-body">
