...
@endif
        ...
        <div class="user-stats text-center mt-3 pb-0">
          <div class="d-inline-block">
            @if (empty($fcount))
            <a href="#" onclick="showData('following')" class="pr-2">0 <br /> <small class="text-muted">Following</small></a>
            @else
            <a href="#" onclick="showData('following')" class="pr-2">{{$fcount}} <br /> <small class="text-muted">Following</small></a>
            @endif
          </div>
          <div class="d-inline-block">
            @if (empty($count))
            <a href="#" onclick="showData('follower')">0 <br /> <small class="text-muted">Followers</small></a>
            @else
            <a href="#" onclick="showData('follower')">{{$count}} <br /> <small class="text-muted">Followers</small></a>
            @endif
          </div>
          <div class="mt-3">
      ...
      <div class="col-lg-8 pb-0">
        ...
        @yield('content')
        <!-- Do not delete, holding uservalue for JS -->
